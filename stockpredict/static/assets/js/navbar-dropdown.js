!function() {
    ...
    ["scroll", "resize"].forEach((t => {
        document.addEventListener(t, (t => {
            ...
            e = setTimeout((function() {
                !function(e) {
                    "resize" === e.type && (document.body.classList.remove("navbar-dropdown-open"),
                    ...
                    Array.from(document.querySelector(".navbar-dropdown").querySelectorAll('.navbar-toggler[aria-expanded="true"]')).forEach((e => {
                    ...
                    Array.from(document.querySelectorAll(".navbar-dropdown")).forEach((e => {
                        e.matches(".navbar-fixed-top") && (e.matches(".transparent") && !e.classList.contains("opened") && (t > 0 ? e.classList.remove("bg-color") : e.classList.add("bg-color")),
                        t > 0 ? e.classList.add("navbar-short") : e.classList.remove("navbar-short"))
                    }
                    ))
                }(t)
            }
    ...
    ["show.bs.collapse", "hide.bs.collapse"].forEach((e => {
        document.addEventListener(e, ( ({target: t}) => {
            ...
            o && ("show.bs.collapse" === e ? (document.body.classList.add("navbar-dropdown-open"),
            o.classList.add("opened")) : (document.body.classList.remove("navbar-dropdown-open"),
            o.classList.remove("opened"),
            window.dispatchEvent(new Event("scroll.bs.navbar-dropdown.data-api")),
            o.dispatchEvent(new Event("collapse.bs.navbar-dropdown"))))
        }
        ))
    }
    ));
    document.querySelector("html").classList.contains("is-builder") || document.addEventListener("click", (function(e) {
        const t = e.target;
        if (t.classList.contains("nav-link") || t.parentNode.classList.contains("nav-link"))
            return;
    ...
    document.querySelectorAll(".nav-link.dropdown-toggle").forEach((e => {
