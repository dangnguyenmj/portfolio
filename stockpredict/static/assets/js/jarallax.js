...
, function(e, t, n) {
    ...
    var u, p, d = a.window.navigator, m = -1 < d.userAgent.indexOf("MSIE ") || -1 < d.userAgent.indexOf("Trident/") || -1 < d.userAgent.indexOf("Edge/"), f = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(d.userAgent), g = function() {
    ...
    function y() {
        f ? (!u && document.body && ((u = document.createElement("div")).style.cssText = "position: fixed; top: -9999px; left: 0; height: 100vh; width: 0;",
        document.body.appendChild(u)),
        p = (u ? u.clientHeight : 0) || a.window.innerHeight || document.documentElement.clientHeight) : p = a.window.innerHeight || document.documentElement.clientHeight
    }
    y(),
    ...
    var v = 0
      , x = function() {
        function e(t, n) {
            ...
            o.options = o.extend({}, o.defaults, a, n),
        ...
        n = [{
            key: "css",
            value: function(e, t) {
                return "string" == typeof t ? a.window.getComputedStyle(e).getPropertyValue(t) : (t.transform && g && (t[g] = t.transform),
            ...
            value: function() {
                var e = this
                  ...
                  , r = n
                  , l = 0;
                return i && (0 > o ? (a = o * Math.max(n, p),
                p < n && (a -= o * (n - p))) : a = o * (n + p),
                1 < o ? r = Math.abs(a - p) : 0 > o ? r = a / o + Math.abs(a) : r += (p - n) * (1 - o),
                a /= 2),
            ...
            value: function(e) {
                var t = this
                  ...
                  , r = {}
                  , l = n;
                if (t.options.elementInViewport && (l = t.options.elementInViewport.getBoundingClientRect()),
                t.isElementInViewport = 0 <= l.bottom && 0 <= l.right && l.top <= p && l.left <= a.window.innerWidth,
                e || t.isElementInViewport) {
                    var s = Math.max(0, o)
                      ...
                      , g = 1 - (p - o) / (p + i) * 2
                      , y = 1;
                    if (i < p ? y = 1 - (u || d) / i : c <= p ? y = c / p : m <= p && (y = m / p),
                    "opacity" !== t.options.type && "scale-opacity" !== t.options.type && "scroll-opacity" !== t.options.type || (r.transform = "translate3d(0,0,0)",
                    r.opacity = y),
                    "scale" === t.options.type || "scale-opacity" === t.options.type) {
                        var b = 1;
                        0 > t.options.speed ? b -= t.options.speed * y : b += t.options.speed * (1 - y),
                        r.transform = "scale(".concat(b, ") translate3d(0,0,0)")
                    }
                    if ("scroll" === t.options.type || "scroll-opacity" === t.options.type) {
                        var h = t.parallaxScrollDistance * g;
                        "absolute" === t.image.position && (h -= o),
                        r.transform = "translate3d(0,".concat(h, "px,0)")
                    }
      ...
      , w = function(e, t) {
        ...
        for (var n, o = e.length, i = 0, a = arguments.length, r = new Array(a > 2 ? a - 2 : 0), l = 2; l < a; l++)
            r[l - 2] = arguments[l];
        for (; i < o; i += 1)
            if ("object" === s(t) || void 0 === t ? e[i].jarallax || (e[i].jarallax = new x(e[i],t)) : e[i].jarallax && (n = e[i].jarallax[t].apply(e[i].jarallax, r)),
            void 0 !== n)
                return n;
        return e
    };
