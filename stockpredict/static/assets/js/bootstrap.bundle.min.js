...
!function(t, e) {
            ...
            var s, r, a = {
                ...
                forceUpdate: function() {
                    if (!c) {
                        ...
                        if (oe(e, i)) {
                            a.rects = {
                                reference: ne(e, Tt(i), "fixed" === a.options.strategy),
                                popper: gt(i)
                            },
                            a.reset = !1,
    ...
    var ae = re()
      , le = re({
        defaultModifiers: [Mt, ee, jt, ft]
    })
      , ce = re({
        defaultModifiers: [Mt, ee, jt, ft, te, Qt, ie, Nt, Jt]
    })
      , de = Object.freeze({
        __proto__: null,
        popperGenerator: re,
    ...
    const he = new RegExp("ArrowUp|ArrowDown|Escape")
      , ue = _() ? "top-end" : "top-start"
      , fe = _() ? "top-start" : "top-end"
      , pe = _() ? "bottom-end" : "bottom-start"
      , me = _() ? "bottom-start" : "bottom-end"
      , ge = _() ? "left-start" : "right-start"
      , _e = _() ? "right-start" : "left-start"
      , be = {
        offset: [0, 2],
    ...
    class ye extends R {
        ...
        _getPlacement() {
            ...
            return t.classList.contains("dropup") ? e ? fe : ue : e ? me : pe
        }
        _detectNavbar() {
        ...
        static dropdownInterface(t, e) {
            ...
            if (i || (i = new ye(t,"object" == typeof e ? e : null)),
            "string" == typeof e) {
                if (void 0 === i[e])
                    throw new TypeError(`No method named "${e}"`);
                i[e]()
        ...
        static dataApiKeydownHandler(e) {
            if (/input|textarea/i.test(e.target.tagName) ? "Space" === e.key || "Escape" !== e.key && ("ArrowDown" !== e.key && "ArrowUp" !== e.key || e.target.closest(".dropdown-menu")) : !he.test(e.key))
                return;
            ...
            if ("Escape" === e.key)
                return n().focus(),
                void ye.clearMenus();
            i || "ArrowUp" !== e.key && "ArrowDown" !== e.key ? i && "Space" !== e.key ? ye.getInstance(n())._selectMenuItem(e) : ye.clearMenus() : n().click()
        }
    }
    H.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', ye.dataApiKeydownHandler),
    H.on(document, "keydown.bs.dropdown.data-api", ".dropdown-menu", ye.dataApiKeydownHandler),
    H.on(document, "click.bs.dropdown.data-api", ye.clearMenus),
    H.on(document, "keyup.bs.dropdown.data-api", ye.clearMenus),
    H.on(document, "click.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', (function(t) {
        t.preventDefault(),
        ye.dropdownInterface(this)
    }
    )),
    b(ye);
    const we = () => {
      ...
      , Ee = (t=we()) => {
        ...
        Ae(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", "paddingRight", (e => e + t)),
    ...
    class Se extends R {
        ...
        static jQueryInterface(t, e) {
            return this.each((function() {
                const i = Se.getInstance(this) || new Se(this,"object" == typeof t ? t : {});
                if ("string" == typeof t) {
                    if (void 0 === i[t])
    ...
    H.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', (function(t) {
        ...
        (Se.getInstance(e) || new Se(e)).toggle(this)
    }
    )),
    b(Se);
    const Ie = {
    ...
    class Pe extends R {
        ...
        static jQueryInterface(t) {
            return this.each((function() {
                const e = w.get(this, "bs.offcanvas") || new Pe(this,"object" == typeof t ? t : {});
                if ("string" == typeof t) {
    ...
    H.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', (function(e) {
        ...
        n && n !== i && Pe.getInstance(n).hide(),
        (w.get(i, "bs.offcanvas") || new Pe(i)).toggle(this)
    }
    )),
    H.on(window, "load.bs.offcanvas.data-api", ( () => {
        t.find(".offcanvas.show").forEach((t => (w.get(t, "bs.offcanvas") || new Pe(t)).show()))
    }
    )),
    b(Pe);
    const Me = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"])
      ...
      , Be = (t, e) => {
        ...
        if (e.includes(i))
            return !Me.has(i) || Boolean(He.test(t.nodeValue) || Re.test(t.nodeValue));
    ...
    const qe = new RegExp("(^|\\s)bs-tooltip\\S+","g")
    ...
    class Ke extends R {
        ...
        show() {
            ...
            this._popper ? this._popper.update() : this._popper = ce(this._element, s, this._getPopperConfig(a)),
        ...
        setElementContent(t, e) {
            if (null !== t)
                ...
                t.appendChild(e)) : t.textContent = e.textContent)) : void (this._config.html ? (this._config.sanitize && (e = We(e, this._config.allowList, this._config.sanitizeFn)),
        ...
        static jQueryInterface(t) {
            return this.each((function() {
                ...
                if ((e || !/dispose|hide/.test(t)) && (e || (e = new Ke(this,i)),
                "string" == typeof t)) {
                    if (void 0 === e[t])
                        throw new TypeError(`No method named "${t}"`);
                    e[t]()
    ...
    class Ze extends Ke {
        ...
        static jQueryInterface(t) {
            return this.each((function() {
                ...
                if ((e || !/dispose|hide/.test(t)) && (e || (e = new Ze(this,i),
    ...
    H.on(window, "load.bs.scrollspy.data-api", ( () => {
        t.find('[data-bs-spy="scroll"]').forEach((t => new ei(t)))
    }
    )),
    b(ei);
    class ii extends R {
        ...
        static jQueryInterface(t) {
            return this.each((function() {
                const e = w.get(this, "bs.tab") || new ii(this);
                if ("string" == typeof t) {
                    if (void 0 === e[t])
                        throw new TypeError(`No method named "${t}"`);
                    e[t]()
    ...
    H.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', (function(t) {
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
        u(this) || (w.get(this, "bs.tab") || new ii(this)).show()
    }
    )),
    b(ii);
    const ni = {
    ...
    class oi extends R {
        ...
        static jQueryInterface(t) {
            return this.each((function() {
                ...
                if (e || (e = new oi(this,"object" == typeof t && t)),
                "string" == typeof t) {
                    if (void 0 === e[t])
                        throw new TypeError(`No method named "${t}"`);
                    e[t](this)
